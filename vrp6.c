...
int burst_open(struct inode *inode, struct file *filp)
{
...
int burst_release(struct inode *inode, struct file *filp)
{
	printk("burst_release\n");
	return 0;
}

ssize_t burst_read(struct file *filp, char __user *buf, size_t count,
                loff_t *f_pos)
{
